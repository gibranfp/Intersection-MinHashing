...
void imh_init_rng(unsigned long long);
...
ListDB imh_create_sublistdb_from_listdb(ListDB *, uint *, uint, uint, uint *);
void imh_store_list(List *, uint, HashTable *);
void imh_store_sublistdb(ListDB *, uint *, HashTable *);
#endif
